...
class Tasks extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['author_id', 'address', 'lat', 'long'], 'required','message'=>'Нада заполнить это поле правильно, иначе капец будет'],
            [['author_id', 'performer_id', 'cat_id'], 'integer','message'=>'Интегральное только значение поля должно біть'],
            [['about'], 'string'],
            [['timeout', 'time_add', 'time_close', 'time_start', 'time_expire'], 'safe'],
            [['status', 'name', 'location', 'inc_files', 'address'], 'string', 'max' => 255],
            [['money'], 'string', 'max' => 11,'message'=>'m1111111!!'],
