...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= SERVER_PATH ?>css/normalize.css">
        <link rel="stylesheet" href="<?= SERVER_PATH ?>css/style.css">
    </head>
    <?= $this->beginBody() ?>
    <body>
            ...
            <div class="main-container page-header__container">
                ...
                <div class="header__nav">
                    <ul class="header-nav__list site-list">
                        <li class="site-list__item">
                            <a href="<?= SERVER_PATH ?>tasks">Задания</a>
                        </li>
                        <li class="site-list__item">
                            <a href="<?= SERVER_PATH ?>users">Исполнители</a>
                        </li>
                        <li class="site-list__item">
                            <a href="<?= SERVER_PATH ?>tasks/create">Создать задание</a>
                        </li>
                        <li class="site-list__item">
                            <a href="<?= SERVER_PATH ?>profile">Мой профиль</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="header__account">
                    <a class="header__account-photo">
                        <img src="<?= SERVER_PATH ?>img/user-photo.png"
                             width="43" height="44"
                ...
                <div class="page-footer__copyright">
                    <a>
                        <img class="copyright-logo"
                             src="<?= SERVER_PATH ?>img/academy-logo.png"
                             width="185" height="63"
    ...
    <script src="<?= SERVER_PATH ?>js/main.js"></script>
    <script src="<?= SERVER_PATH ?>js/messenger.js"></script>
    </body>
    <?= $this->endBody() ?>
    </html>
<?php $this->endPage();
